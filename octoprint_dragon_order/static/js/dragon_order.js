...
$(function() {
	function dragon_orderViewModel(parameters) {
		...
		self.onAllBound = function(allViewModels){
			...
			$('#tabs,#tabs li ul.dropdown-menu').sortable({axis: 'x', distance: 10, connectWith: '#tabs li ul.dropdown-menu,#tabs', items: 'li:not(.dropdown)', update:function(event, ui){
			...
			$('body > div > div.container.octoprint-container > div.row > div.accordion.span4').sortable({axis:'y', distance: 10, handle: 'div.accordion-heading', update:function(){
			...
			$('#navbar > div > div > div > ul.nav').sortable({axis: 'x', distance: 10, update:function(){
